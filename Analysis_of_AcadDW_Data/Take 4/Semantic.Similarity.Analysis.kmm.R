...
clusters.info.list <- clusters.kmm$cluster
...
write.csv(clusters.info.df, file = "clusters.info.df.csv", row.names = TRUE, col.names = TRUE)
write.csv(dept.cluster.matrix, file = "dept.cluster.matrix.csv", row.names = TRUE, col.names = TRUE)
write.csv(dept.distribution.percentage, file = "dept.distribution.percentage.csv", row.names = TRUE, col.names = TRUE)
write.csv(cluster.composition.percentage, file = "cluster.composition.percentage.csv", row.names = TRUE, col.names = TRUE)
