...
write.csv2(clusters.info.df, file = "clusters.info.df.csv", row.names = TRUE)
write.csv2(dept.cluster.matrix, file = "dept.cluster.matrix.csv", row.names = TRUE)
write.csv2(dept.distribution.percentage, file = "dept.distribution.percentage.csv", row.names = TRUE)
write.csv2(cluster.composition.percentage, file = "cluster.composition.percentage.csv", row.names = TRUE)
